...
%\title{Случайный поиск в задаче о назначениях}

% Тема
%\topic{\normalfont\scshape%
%   ЭССЕ НА ТЕМУ <<ВЕРОЯТНОСТНЫЕ МЕТОДЫ РЕШЕНИЯ ВЫЧИСЛИТЕЛЬНЫХ ЗАДАЧ>>}
...
%Тестовая выборка нужна для того, чтобы проверять насколько близок результат оценки функции $f$ на ранее не наблюдаемых данных к  значению функции $f$.
